...
parser.add_argument ('image_dir', help = 'Point to impage file for prediction.', type = str)
parser.add_argument ('--load_dir', help = 'Checkpoint path. Optional', default = "checkpoint.pth", type = str)
parser.add_argument ('--top_k', help = 'Choose top K matches as int.', default = 5, type = int)
...
args.category_names = args.category_names or 'cat_to_name.json'
